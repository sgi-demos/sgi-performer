...
#define LAYERED_MULTICOLORED_FOG (PFVFOG_LAYERED_FOG<<1)
...
typedef struct
{
    ...
    int             volFogType;
    pfVolFog        *volFog;
    pfVolFog        *volFogToBeDeleted;         /* used by draw to delete 
						   texture handle */
    pfNode          *fogNode;      
    int             volFogTexHandleDeleted;
    float           fogPatchyDensity;
    float           fogLayeredDensity;
    int             patchyFogMode;
    int             layeredFogMode;
} SharedViewState;
