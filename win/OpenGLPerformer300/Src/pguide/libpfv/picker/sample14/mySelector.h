...
#define ACTION_SCALE   1
#define ACTION_HEADING 2
...
public:
	...
	int joinSelection( pfvPicker* p, pfvSelector* _master, int ev );
	int manageSelection( pfvPicker*p, pfList*_listSlaves );
