...
main (int argc, char *argv[])
{
	...
	myNavigator* nav = new myNavigator;
	nav->setViewIndex(i);
	viewer->addModule((pfvModule*)nav);

	myPickerModule* picker = new myPickerModule;
	picker->setViewIndex(i);
	viewer->addModule((pfvModule*)picker);
    }
