...
class PFUIDLLEXPORT pfiInputXformDrive : public pfiInputXformTravel
{
  private:
    static pfType *classType;
  private:
    float			xDriveHeight, xResetDriveHeight;
  public:	/****** constructor/destructors ******/
    pfiInputXformDrive(void);
  public:	/* type */
    static void	   init();
    static pfType* getClassType() { return classType; }
    virtual const char*	getTypeName(void) const { return "pfiInputXformDrive"; }
  public:	/****** drive interface ******/
    virtual void	setDriveHeight(float _height) {
	xResetDriveHeight = xDriveHeight = _height;
    }
    virtual void	setCurDriveHeight(float _height) {
  ...
  public:	public:	/****** generic interface ******/
    virtual float	getDriveHeight(void) const { return xDriveHeight; }
