...
/**
  *
  * this version of getopt() comes from cmdline.c from perfly
  *
  */
...
PFUDLLEXPORT char *optarg;
PFUDLLEXPORT int optind = 1, opterr = 0;

PFUDLLEXPORT int getopt(int argc, char *argv[], const char *optstring)
{
