/*
 * WARNING! DO NOT EDIT!
 * pfiInitD.C automatically generated from ../../lib/libpfui/pfiInit.C
 */
/*
...
#include <Performer/pfuiD/pfiPickD.h>
#include <Performer/pfuiD/pfiCollideD.h>


static int pfiClassesInited = 0;


void
_pfiClassInitCheck(void)
{
    if (!pfiClassesInited)
    {
	pfNotify(PFNFY_WARN, PFNFY_USAGE, "pfiInit() has not been called!");
	pfNotify(PFNFY_WARN, PFNFY_MORE,
	    "Call pfiInit() before any other pfi routines and before the forked-creation"
	    " of any additional processes using pfiClasses.");
	pfiInit();
    }
