...
#ifndef __PFUBARRIER_H
#define __PFUBARRIER_H

#include <Performer/pr.h> /* for definition of PF_USPTR_T */
...
extern pfuBarrier *pfuBarrierCreate(PF_USPTR_T *usptr);
extern void pfuBarrierDestroy(pfuBarrier *b);
extern void pfuBarrierEnter(pfuBarrier *b, unsigned int n);

#ifdef __cplusplus
}
#endif

#endif /* __PFUBARRIER_H */
