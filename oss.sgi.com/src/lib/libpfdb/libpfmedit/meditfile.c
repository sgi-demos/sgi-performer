...
/************************************************************************
Medit filer, used to read/write Medit files. See file "libmedit.doc"
for more details.
************************************************************************/
#include "Meditstuff/useful.h"
#include "Meditstuff/meditfile.h"
#include "libmedit.h"
#include "Meditstuff/meditfiler.c"
#include "Meditstuff/read_medit.c"
#include "Meditstuff/write_medit.c"
#include "Meditstuff/free_medit.c"
