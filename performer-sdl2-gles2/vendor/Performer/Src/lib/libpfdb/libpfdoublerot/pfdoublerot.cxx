...
/*
 * pfdoublerot.c - ".doublerot" pseudo-loader.
 *
 * To load a file and rotate it, say:
 *	perfly <filename>.<h>,<p>,<r>.doublerot
...
pfdLoadFile_doublerot(char *fileName)
{
    double h, p, r;
    ...
    if ((lastdot = strrchr(fileName, '.')) == NULL
     ...
     || sscanf(firstdot+1, "%lf,%lf,%lf", &h, &p, &r) != 3)
    {
	pfNotify(PFNFY_WARN, PFNFY_USAGE,
		"pfdLoadFile_doublerot: bad file name %s", fileName);
	return NULL;
    }
