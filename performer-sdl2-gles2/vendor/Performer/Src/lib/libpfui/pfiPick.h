...
class PFUIDLLEXPORT pfiPick : public pfObject
{
  private:
  ...
  public:	/* constructor/destructors */
    pfiPick(void);
    virtual ~pfiPick(void);
  public:	/****** callbacks and associated data *****/
    void		 *pHitCBData;
    pfiPickFuncType	 pHitCB;
  public:	/****** type *****/
    static void	   init();
    static pfType* getClassType() { return classType; }
    virtual const char*	getTypeName(void) const { return "pfiPick"; }
  public:	/***** sets/gets *****/
    void		 setMode(int _mode, int _val);
    int			 getMode(int _mode) const;
    void		 setHitFunc(pfiPickFuncType _func, void *_data) {
	pHitCB = _func;
	pHitCBData = _data;
    }
    void		 getHitFunc(pfiPickFuncType *_func, void **_data) {
	*_func = pHitCB;
	*_data = pHitCBData;
    }
