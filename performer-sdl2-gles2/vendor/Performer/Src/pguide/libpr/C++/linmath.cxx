...
static void 
PrintVec3(const pfVec3 v)
{
    printf("%10.5f %10.5f %10.5f\n", v[0], v[1], v[2]);
}

static void 
PrintQuat(const pfQuat v)
{
...
static void 
DbgPrintVec3(const char *msg, const pfVec3 v)
{
    if (verbose)
    {
	printf("%s:\n", msg);
...
static void 
DbgPrintQuat(const char *msg, const pfQuat v)
{
    if (verbose)
    {
	printf("%s:\n", msg);
...
static void 
DbgPrintMat(const char *msg, const pfMatrix m)
{
    if (verbose)
    {
	printf("%s:\n", msg);
...
static int
_AssertEqVec3(const pfVec3 v1, const pfVec3 v2, const char *msg, 
...
static int
_AssertEqQuat(const pfQuat v1, const pfQuat v2, const char *msg, 
			 const char *file, const long line)
{
    pfQuat qq1;
    int ret = TRUE;
...
static int
_AssertEqMat(const pfMatrix m1, const pfMatrix m2, const char *msg, 
			 const char *file, const long line)
{
    int ret = TRUE;
    long i, j;
