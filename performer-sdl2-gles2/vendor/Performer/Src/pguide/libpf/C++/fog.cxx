...
//
//
// fogC.C: Performer program to demonstrate use of fog.  
//        Based on simple.c
//
// $Revision: 1.17 $ 
// $Date: 2000/10/11 00:45:13 $ 
//
...
OpenPipeWin (pfPipeWindow *pw)
{
    ...
    fog->setColor(1.0f, 1.0f, 1.0f);
    pfNotify(PFNFY_NOTICE, PFNFY_PRINT, "Radius: %f", bsphere->radius);
    fog->setRange(1.0f * bsphere->radius, 4.0f * bsphere->radius);
    fog->apply();
    pfEnable (PFEN_FOG);
