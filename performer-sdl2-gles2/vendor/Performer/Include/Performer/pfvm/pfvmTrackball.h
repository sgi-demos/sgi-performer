...
#ifndef __PFV_TRACKBALL_H__
#define __PFV_TRACKBALL_H__
...
class pfvmTrackball : public pfvModule
{
public:	
    pfvmTrackball( pfvXmlNode* xml=NULL);
    ~pfvmTrackball();

    static void init();
    static pfType* getClassType(){ return classType; }
    virtual const char* getTypeName() const {return "pfvmTrackball";}
...
private:
    ...
    pfVec3 startPt;
    pfVec3 startChanXYZ, startChanHPR;

    pfMatrix rotMat;
    pfMatrix resultMat;
    pfMatrix startChanMat;
    pfCoord resultCoord;
    pfMatrix spinMat;
...
#endif // end of __PFV_TRACKBALL_H__
