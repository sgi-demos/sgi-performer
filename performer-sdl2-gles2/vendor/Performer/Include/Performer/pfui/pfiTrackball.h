...
class PFUIDLLEXPORT pfiInputXformTrackball : public pfiInputXform
{
  private:
    static pfType *classType;
  public:
    float		xSpeedScale, xDBSize; /* multipliers for start speed */
    float		xAccelRate;	    /* extra acceleration/deceleration multiplier */
    float		xPrevDeltaX, xPrevDeltaY;
    pfVec3		xTranslation; // accumulate translation
    pfMatrix		xSpinMat; // accumulated rotations
    pfMatrix		xPosMat; // object positioning matrix
    pfMatrix		xHPRMat, xHPRInvMat; 
    short		xSpin;	    /* booleans */
  public:	/* constructor/destructors */
    pfiInputXformTrackball(void);
  public:	/****** type *****/
    static void	   init();
    static pfType* getClassType() { return classType; }
    virtual const char*	getTypeName(void) const { return "pfiInputXformTrackball"; }
  public:	/* sets/gets */
    virtual void	_setBSphere(pfSphere* _sphere);
    virtual void	setMotionLimits(float _maxSpeed, float _angularVel, float _accel);
